...
const PortViewPage = () => {
  ...
  const defaultPorts = [
    { port: '3000', name: 'React Dev Server', description: 'Default React development server', isPublic: false },
    { port: '5001', name: 'Backend API', description: 'Node.js/Express backend server', isPublic: false },
    { port: '8000', name: 'Frontend App', description: 'Current frontend application', isPublic: true },
    { port: '3001', name: 'Alternative React', description: 'Secondary React development port', isPublic: false },
    { port: '4000', name: 'GraphQL Server', description: 'GraphQL API server', isPublic: false },
    { port: '8080', name: 'HTTP Server', description: 'Common HTTP server port', isPublic: false },
    { port: '9000', name: 'Development Server', description: 'General development server', isPublic: false }
  ];
